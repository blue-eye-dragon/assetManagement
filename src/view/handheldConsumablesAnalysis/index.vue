  ...
  <div>
    ...
    <div class="myEchartsBox">
        <div class="echartsBox">
          ...
          <div id="name1" class="echartsContent"></div>
        </div>
        <div class="echartsBox">
          <titleBox titleName="耗材入库金额占比"></titleBox>
          <div id="name2" class="echartsContent"></div>
        </div>
        <div class="echartsBox">
          <titleBox titleName="耗材入库分类占比构成"></titleBox>
          <div id="name3" class="echartsContent"></div>
        </div>
        <div class="echartsBox">
          <el-tabs v-model="activeName" @tab-click="handleClick">
              <el-tab-pane label="卫生材料入库" name="first">
                <div id="name4" class="echartsContent"></div>
              </el-tab-pane>
              <el-tab-pane label="低值消耗品入库" name="second">
                <div id="name5" class="echartsContent"></div>
              </el-tab-pane>
          </el-tabs>
        </div>
        <div class="echartsBox">
          <titleBox titleName="卫生材料入库占比"></titleBox>
          <div id="name6" class="echartsContent"></div>
        </div>
        <div class="echartsBox">
          <titleBox titleName="低值易耗品入库占比"></titleBox>
          <div id="name7" class="echartsContent"></div>
        </div>
        <div class="echartsBox">
          <titleBox titleName="耗材入库供应商排名TOP10"></titleBox>
          <div id="name8" class="echartsContent"></div>
        </div>
        <div class="echartsBox">
          <titleBox titleName="耗材明细入库金额TOP10"></titleBox>
          <div id="name9" class="echartsContent"></div>
        </div>
        <div class="echartsBox">
          <titleBox titleName="耗材退库TOP10"></titleBox>
          <div id="name10" class="echartsContent"></div>
        </div>
    </div>
...
export default {
    ...
    methods: {
        ...
        initname1 () {
            ...
            var chartDom = document.getElementById('name1');
        ...
        initname2 () {
            ...
            var chartDom = document.getElementById('name2');
        ...
        initname3 () {
            ...
            var chartDom = document.getElementById('name3');
        ...
        initname4 () {
            ...
            var chartDom = document.getElementById('name4');
        ...
        initname5 () {
            ...
            var chartDom = document.getElementById('name5');
        ...
        initname6 () {
            ...
            var chartDom = document.getElementById('name6');
        ...
        initname7 () {
            ...
            var chartDom = document.getElementById('name7');
        ...
        initname8 () {
            ...
            var chartDom = document.getElementById('name8');
        ...
        initname9 () {
            ...
            var chartDom = document.getElementById('name9');
        ...
        initname10 () {
            ...
            var chartDom = document.getElementById('name10');
