  ...
  <div>
    ...
    <div class="myEchartsBox">
        <div class="echartsBox">
          <titleBox titleName="耗材入库金额"></titleBox>
          <div id="inventory1" class="echartsContent"></div>
        </div>
        <div class="echartsBox">
          <titleBox titleName="耗材入库金额占比"></titleBox>
          <div id="inventory2" class="echartsContent"></div>
        </div>
        <div class="echartsBox">
          <titleBox titleName="耗材入库分类占比构成"></titleBox>
          <div id="inventory3" class="echartsContent"></div>
        </div>
        <div class="echartsBox">
          <el-tabs v-model="activeName" @tab-click="handleClick">
              <el-tab-pane label="卫生材料入库" name="first">
                <div id="inventory4" class="echartsContent"></div>
              </el-tab-pane>
              <el-tab-pane label="低值消耗品入库" name="second">
                <div id="inventory5" class="echartsContent"></div>
              </el-tab-pane>
          </el-tabs>
        </div>
        <div class="echartsBox">
          <titleBox titleName="卫生材料入库占比"></titleBox>
          <div id="inventory6" class="echartsContent"></div>
        </div>
        <div class="echartsBox">
          <titleBox titleName="低值易耗品入库占比"></titleBox>
          <div id="inventory7" class="echartsContent"></div>
        </div>
        <div class="echartsBox">
          <titleBox titleName="耗材入库供应商排名TOP10"></titleBox>
          <div id="inventory8" class="echartsContent"></div>
        </div>
        <div class="echartsBox">
          <titleBox titleName="耗材明细入库金额TOP10"></titleBox>
          <div id="inventory9" class="echartsContent"></div>
        </div>
        <div class="echartsBox">
          <titleBox titleName="耗材退库TOP10"></titleBox>
          <div id="inventory10" class="echartsContent"></div>
        </div>
    </div>
    <titleBox titleName="耗材入库汇总统计分析"></titleBox>
...
export default {
    ...
    methods: {
        ...
        initname1 () {
            ...
            var chartDom = document.getElementById('inventory1');
        ...
        initname2 () {
            ...
            var chartDom = document.getElementById('inventory2');
        ...
        initname3 () {
            ...
            var chartDom = document.getElementById('inventory3');
        ...
        initname4 () {
            ...
            var chartDom = document.getElementById('inventory4');
        ...
        initname5 () {
            ...
            var chartDom = document.getElementById('inventory5');
        ...
        initname6 () {
            ...
            var chartDom = document.getElementById('inventory6');
        ...
        initname7 () {
            ...
            var chartDom = document.getElementById('inventory7');
        ...
        initname8 () {
            ...
            var chartDom = document.getElementById('inventory8');
        ...
        initname9 () {
            ...
            var chartDom = document.getElementById('inventory9');
        ...
        initname10 () {
            ...
            var chartDom = document.getElementById('inventory10');
